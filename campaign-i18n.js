...
(function () {
  ...
  function applyCampaignDynamic() {
    ...
    setText('campaign-option-highlight', 'pricing.optionHighlight', '9・10月分が0円');
    setHtml(
      'campaign-option-note',
      'pricing.optionNote',
      '※不要な場合は<span id="campaign-option-cancel-deadline">10月末日</span>までに必ず解約をお願いいたします。'
    );
    setText('campaign-option-cancel-deadline', 'pricing.optionCancelDeadline', '10月末日');
    setText('campaign-notice-deadline', 'pricing.noticeDeadline', '10月末日まで');
